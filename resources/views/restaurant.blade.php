...
<body>
            ...
            <ul class='navbar-items'>
                ...
                <li id="float-r">
                    <div class="logout">
                        ...
                        <?php echo "<h1 style='color: #fff; width: min-content; margin-left: 5px; margin-right: 10px; text-transform: capitalize;'>" . $_SESSION['logged_user'] . "</h1>"; ?>
                        <div id="cart">
                        <?php
                            $outputCheckout = "";
                            $total = 0;
    ...
    for($i = 0; $i < count($result); $i++){
        ...
        echo "<div class='left-div'><div class='center-text'><h1>" . $result[$i]['name'] . "</h1></div>";
        echo "<div class='image-div'><img src=../" . $result[$i]["image_path"] . "></div></div>";
        echo "<div class='right-div'><div class='center-text desc-clicked'><p>" . $result[$i]['description'] . "</p></div>";
        echo "<div class='center-text'><h2>" . $result[$i]['price'] . "</h2></div></div></div><div class='line'></div>";
        echo "<div class='products'><h1>Меню:</h1><h2>Какво предлага ресторанта.</h2><table><tr><th>Тип Храна:</th><th>Грамаж:</th><th>Цена:</th><th>Добавяне:</th></tr>";
        ...
        echo "</table></div><div class='line'></div>";  
    }  
    ?>
